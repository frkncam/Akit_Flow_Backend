...
import com.muhur.signature.exception.CertificateLoadingException;
import com.muhur.signature.repository.OrganizationCertificateRepository;
import com.muhur.signature.util.PemUtils;
...
public class CertificateServiceImpl implements CertificateService {
    ...
    private CertKeyPair createAndStore(Long organizationId) {
        try {
            ...
            X500Name subject = new X500Name("CN=Mühür Org " + organizationId + ", O=Mühür");
