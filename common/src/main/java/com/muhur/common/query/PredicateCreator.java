 ...
 * grid-common PredicateCreator'ının Mühür uyarlamasıdır (exception ve enum parse farklı).
 */
@Slf4j
@UtilityClass
public class PredicateCreator {
    ...
    /**
     * Mühür uyarlaması: grid-common 'fromValue' static metodunu çağırıyordu; Mühür enum'larında o yok.
