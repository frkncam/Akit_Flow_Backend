...
import com.akitflow.notification.event.payload.ContractStatusChangedPayload;
...
public class ContractStatusChangedListener {
    ...
    public void onMessage(ContractEventEnvelope<ContractStatusChangedPayload> event) {
