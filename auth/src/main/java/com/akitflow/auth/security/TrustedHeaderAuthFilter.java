 ...
 *
 * Public endpoints (register/login/refresh/invite-accept) don't need
 * authentication and the gateway lets them through without these headers;
 * SecurityConfig path-matchers handle that.
 */
    ...
    protected void doFilterInternal(HttpServletRequest req,
        ...
        if (userId != null && !userId.isBlank() && role != null && !role.isBlank()) {
            try {
                ...
                // malformed → leave unauthenticated
            }
        }
